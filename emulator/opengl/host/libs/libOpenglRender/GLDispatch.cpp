...
bool init_gl_dispatch()
{
    ...
    s_gl.glPointSizePointerOES = (glPointSizePointerOES_t) s_egl.eglGetProcAddress("glPointSizePointerOES");
    s_gl.glBlendEquationSeparateOES = (glBlendEquationSeparateOES_t) s_egl.eglGetProcAddress("glBlendEquationSeparateOES");
    s_gl.glBlendFuncSeparateOES = (glBlendFuncSeparateOES_t) s_egl.eglGetProcAddress("glBlendFuncSeparateOES");
    s_gl.glBlendEquationOES = (glBlendEquationOES_t) s_egl.eglGetProcAddress("glBlendEquationOES");
    s_gl.glDrawTexsOES = (glDrawTexsOES_t) s_egl.eglGetProcAddress("glDrawTexsOES");
    s_gl.glDrawTexiOES = (glDrawTexiOES_t) s_egl.eglGetProcAddress("glDrawTexiOES");
    s_gl.glDrawTexxOES = (glDrawTexxOES_t) s_egl.eglGetProcAddress("glDrawTexxOES");
    s_gl.glDrawTexsvOES = (glDrawTexsvOES_t) s_egl.eglGetProcAddress("glDrawTexsvOES");
    s_gl.glDrawTexivOES = (glDrawTexivOES_t) s_egl.eglGetProcAddress("glDrawTexivOES");
    s_gl.glDrawTexxvOES = (glDrawTexxvOES_t) s_egl.eglGetProcAddress("glDrawTexxvOES");
    s_gl.glDrawTexfOES = (glDrawTexfOES_t) s_egl.eglGetProcAddress("glDrawTexfOES");
    s_gl.glDrawTexfvOES = (glDrawTexfvOES_t) s_egl.eglGetProcAddress("glDrawTexfvOES");
    s_gl.glEGLImageTargetTexture2DOES = (glEGLImageTargetTexture2DOES_t) s_egl.eglGetProcAddress("glEGLImageTargetTexture2DOES");
    s_gl.glEGLImageTargetRenderbufferStorageOES = (glEGLImageTargetRenderbufferStorageOES_t) s_egl.eglGetProcAddress("glEGLImageTargetRenderbufferStorageOES");
    s_gl.glAlphaFuncxOES = (glAlphaFuncxOES_t) s_egl.eglGetProcAddress("glAlphaFuncxOES");
    s_gl.glClearColorxOES = (glClearColorxOES_t) s_egl.eglGetProcAddress("glClearColorxOES");
    s_gl.glClearDepthxOES = (glClearDepthxOES_t) s_egl.eglGetProcAddress("glClearDepthxOES");
    s_gl.glClipPlanexOES = (glClipPlanexOES_t) s_egl.eglGetProcAddress("glClipPlanexOES");
    s_gl.glColor4xOES = (glColor4xOES_t) s_egl.eglGetProcAddress("glColor4xOES");
    s_gl.glDepthRangexOES = (glDepthRangexOES_t) s_egl.eglGetProcAddress("glDepthRangexOES");
    s_gl.glFogxOES = (glFogxOES_t) s_egl.eglGetProcAddress("glFogxOES");
    s_gl.glFogxvOES = (glFogxvOES_t) s_egl.eglGetProcAddress("glFogxvOES");
    s_gl.glFrustumxOES = (glFrustumxOES_t) s_egl.eglGetProcAddress("glFrustumxOES");
    s_gl.glGetClipPlanexOES = (glGetClipPlanexOES_t) s_egl.eglGetProcAddress("glGetClipPlanexOES");
    s_gl.glGetFixedvOES = (glGetFixedvOES_t) s_egl.eglGetProcAddress("glGetFixedvOES");
    s_gl.glGetLightxvOES = (glGetLightxvOES_t) s_egl.eglGetProcAddress("glGetLightxvOES");
    s_gl.glGetMaterialxvOES = (glGetMaterialxvOES_t) s_egl.eglGetProcAddress("glGetMaterialxvOES");
    s_gl.glGetTexEnvxvOES = (glGetTexEnvxvOES_t) s_egl.eglGetProcAddress("glGetTexEnvxvOES");
    s_gl.glGetTexParameterxvOES = (glGetTexParameterxvOES_t) s_egl.eglGetProcAddress("glGetTexParameterxvOES");
    s_gl.glLightModelxOES = (glLightModelxOES_t) s_egl.eglGetProcAddress("glLightModelxOES");
    s_gl.glLightModelxvOES = (glLightModelxvOES_t) s_egl.eglGetProcAddress("glLightModelxvOES");
    s_gl.glLightxOES = (glLightxOES_t) s_egl.eglGetProcAddress("glLightxOES");
    s_gl.glLightxvOES = (glLightxvOES_t) s_egl.eglGetProcAddress("glLightxvOES");
    s_gl.glLineWidthxOES = (glLineWidthxOES_t) s_egl.eglGetProcAddress("glLineWidthxOES");
    s_gl.glLoadMatrixxOES = (glLoadMatrixxOES_t) s_egl.eglGetProcAddress("glLoadMatrixxOES");
    s_gl.glMaterialxOES = (glMaterialxOES_t) s_egl.eglGetProcAddress("glMaterialxOES");
    s_gl.glMaterialxvOES = (glMaterialxvOES_t) s_egl.eglGetProcAddress("glMaterialxvOES");
    s_gl.glMultMatrixxOES = (glMultMatrixxOES_t) s_egl.eglGetProcAddress("glMultMatrixxOES");
    s_gl.glMultiTexCoord4xOES = (glMultiTexCoord4xOES_t) s_egl.eglGetProcAddress("glMultiTexCoord4xOES");
    s_gl.glNormal3xOES = (glNormal3xOES_t) s_egl.eglGetProcAddress("glNormal3xOES");
    s_gl.glOrthoxOES = (glOrthoxOES_t) s_egl.eglGetProcAddress("glOrthoxOES");
    s_gl.glPointParameterxOES = (glPointParameterxOES_t) s_egl.eglGetProcAddress("glPointParameterxOES");
    s_gl.glPointParameterxvOES = (glPointParameterxvOES_t) s_egl.eglGetProcAddress("glPointParameterxvOES");
    s_gl.glPointSizexOES = (glPointSizexOES_t) s_egl.eglGetProcAddress("glPointSizexOES");
    s_gl.glPolygonOffsetxOES = (glPolygonOffsetxOES_t) s_egl.eglGetProcAddress("glPolygonOffsetxOES");
    s_gl.glRotatexOES = (glRotatexOES_t) s_egl.eglGetProcAddress("glRotatexOES");
    s_gl.glSampleCoveragexOES = (glSampleCoveragexOES_t) s_egl.eglGetProcAddress("glSampleCoveragexOES");
    s_gl.glScalexOES = (glScalexOES_t) s_egl.eglGetProcAddress("glScalexOES");
    s_gl.glTexEnvxOES = (glTexEnvxOES_t) s_egl.eglGetProcAddress("glTexEnvxOES");
    s_gl.glTexEnvxvOES = (glTexEnvxvOES_t) s_egl.eglGetProcAddress("glTexEnvxvOES");
    s_gl.glTexParameterxOES = (glTexParameterxOES_t) s_egl.eglGetProcAddress("glTexParameterxOES");
    s_gl.glTexParameterxvOES = (glTexParameterxvOES_t) s_egl.eglGetProcAddress("glTexParameterxvOES");
    s_gl.glTranslatexOES = (glTranslatexOES_t) s_egl.eglGetProcAddress("glTranslatexOES");
    s_gl.glIsRenderbufferOES = (glIsRenderbufferOES_t) s_egl.eglGetProcAddress("glIsRenderbufferOES");
    s_gl.glBindRenderbufferOES = (glBindRenderbufferOES_t) s_egl.eglGetProcAddress("glBindRenderbufferOES");
    s_gl.glDeleteRenderbuffersOES = (glDeleteRenderbuffersOES_t) s_egl.eglGetProcAddress("glDeleteRenderbuffersOES");
    s_gl.glGenRenderbuffersOES = (glGenRenderbuffersOES_t) s_egl.eglGetProcAddress("glGenRenderbuffersOES");
    s_gl.glRenderbufferStorageOES = (glRenderbufferStorageOES_t) s_egl.eglGetProcAddress("glRenderbufferStorageOES");
    s_gl.glGetRenderbufferParameterivOES = (glGetRenderbufferParameterivOES_t) s_egl.eglGetProcAddress("glGetRenderbufferParameterivOES");
    s_gl.glIsFramebufferOES = (glIsFramebufferOES_t) s_egl.eglGetProcAddress("glIsFramebufferOES");
    s_gl.glBindFramebufferOES = (glBindFramebufferOES_t) s_egl.eglGetProcAddress("glBindFramebufferOES");
    s_gl.glDeleteFramebuffersOES = (glDeleteFramebuffersOES_t) s_egl.eglGetProcAddress("glDeleteFramebuffersOES");
    s_gl.glGenFramebuffersOES = (glGenFramebuffersOES_t) s_egl.eglGetProcAddress("glGenFramebuffersOES");
    s_gl.glCheckFramebufferStatusOES = (glCheckFramebufferStatusOES_t) s_egl.eglGetProcAddress("glCheckFramebufferStatusOES");
    s_gl.glFramebufferRenderbufferOES = (glFramebufferRenderbufferOES_t) s_egl.eglGetProcAddress("glFramebufferRenderbufferOES");
    s_gl.glFramebufferTexture2DOES = (glFramebufferTexture2DOES_t) s_egl.eglGetProcAddress("glFramebufferTexture2DOES");
    s_gl.glGetFramebufferAttachmentParameterivOES = (glGetFramebufferAttachmentParameterivOES_t) s_egl.eglGetProcAddress("glGetFramebufferAttachmentParameterivOES");
    s_gl.glGenerateMipmapOES = (glGenerateMipmapOES_t) s_egl.eglGetProcAddress("glGenerateMipmapOES");
    s_gl.glMapBufferOES = (glMapBufferOES_t) s_egl.eglGetProcAddress("glMapBufferOES");
    s_gl.glUnmapBufferOES = (glUnmapBufferOES_t) s_egl.eglGetProcAddress("glUnmapBufferOES");
    s_gl.glGetBufferPointervOES = (glGetBufferPointervOES_t) s_egl.eglGetProcAddress("glGetBufferPointervOES");
    s_gl.glCurrentPaletteMatrixOES = (glCurrentPaletteMatrixOES_t) s_egl.eglGetProcAddress("glCurrentPaletteMatrixOES");
    s_gl.glLoadPaletteFromModelViewMatrixOES = (glLoadPaletteFromModelViewMatrixOES_t) s_egl.eglGetProcAddress("glLoadPaletteFromModelViewMatrixOES");
    s_gl.glMatrixIndexPointerOES = (glMatrixIndexPointerOES_t) s_egl.eglGetProcAddress("glMatrixIndexPointerOES");
    s_gl.glWeightPointerOES = (glWeightPointerOES_t) s_egl.eglGetProcAddress("glWeightPointerOES");
    s_gl.glQueryMatrixxOES = (glQueryMatrixxOES_t) s_egl.eglGetProcAddress("glQueryMatrixxOES");
    s_gl.glDepthRangefOES = (glDepthRangefOES_t) s_egl.eglGetProcAddress("glDepthRangefOES");
    s_gl.glFrustumfOES = (glFrustumfOES_t) s_egl.eglGetProcAddress("glFrustumfOES");
    s_gl.glOrthofOES = (glOrthofOES_t) s_egl.eglGetProcAddress("glOrthofOES");
    s_gl.glClipPlanefOES = (glClipPlanefOES_t) s_egl.eglGetProcAddress("glClipPlanefOES");
    s_gl.glGetClipPlanefOES = (glGetClipPlanefOES_t) s_egl.eglGetProcAddress("glGetClipPlanefOES");
    s_gl.glClearDepthfOES = (glClearDepthfOES_t) s_egl.eglGetProcAddress("glClearDepthfOES");
    s_gl.glTexGenfOES = (glTexGenfOES_t) s_egl.eglGetProcAddress("glTexGenfOES");
    s_gl.glTexGenfvOES = (glTexGenfvOES_t) s_egl.eglGetProcAddress("glTexGenfvOES");
    s_gl.glTexGeniOES = (glTexGeniOES_t) s_egl.eglGetProcAddress("glTexGeniOES");
    s_gl.glTexGenivOES = (glTexGenivOES_t) s_egl.eglGetProcAddress("glTexGenivOES");
    s_gl.glTexGenxOES = (glTexGenxOES_t) s_egl.eglGetProcAddress("glTexGenxOES");
    s_gl.glTexGenxvOES = (glTexGenxvOES_t) s_egl.eglGetProcAddress("glTexGenxvOES");
    s_gl.glGetTexGenfvOES = (glGetTexGenfvOES_t) s_egl.eglGetProcAddress("glGetTexGenfvOES");
    s_gl.glGetTexGenivOES = (glGetTexGenivOES_t) s_egl.eglGetProcAddress("glGetTexGenivOES");
    s_gl.glGetTexGenxvOES = (glGetTexGenxvOES_t) s_egl.eglGetProcAddress("glGetTexGenxvOES");
    s_gl.glBindVertexArrayOES = (glBindVertexArrayOES_t) s_egl.eglGetProcAddress("glBindVertexArrayOES");
    s_gl.glDeleteVertexArraysOES = (glDeleteVertexArraysOES_t) s_egl.eglGetProcAddress("glDeleteVertexArraysOES");
    s_gl.glGenVertexArraysOES = (glGenVertexArraysOES_t) s_egl.eglGetProcAddress("glGenVertexArraysOES");
    s_gl.glIsVertexArrayOES = (glIsVertexArrayOES_t) s_egl.eglGetProcAddress("glIsVertexArrayOES");
    s_gl.glDiscardFramebufferEXT = (glDiscardFramebufferEXT_t) s_egl.eglGetProcAddress("glDiscardFramebufferEXT");
    s_gl.glMultiDrawArraysEXT = (glMultiDrawArraysEXT_t) s_egl.eglGetProcAddress("glMultiDrawArraysEXT");
    s_gl.glMultiDrawElementsEXT = (glMultiDrawElementsEXT_t) s_egl.eglGetProcAddress("glMultiDrawElementsEXT");
    s_gl.glClipPlanefIMG = (glClipPlanefIMG_t) s_egl.eglGetProcAddress("glClipPlanefIMG");
    s_gl.glClipPlanexIMG = (glClipPlanexIMG_t) s_egl.eglGetProcAddress("glClipPlanexIMG");
    s_gl.glRenderbufferStorageMultisampleIMG = (glRenderbufferStorageMultisampleIMG_t) s_egl.eglGetProcAddress("glRenderbufferStorageMultisampleIMG");
    s_gl.glFramebufferTexture2DMultisampleIMG = (glFramebufferTexture2DMultisampleIMG_t) s_egl.eglGetProcAddress("glFramebufferTexture2DMultisampleIMG");
    s_gl.glDeleteFencesNV = (glDeleteFencesNV_t) s_egl.eglGetProcAddress("glDeleteFencesNV");
    s_gl.glGenFencesNV = (glGenFencesNV_t) s_egl.eglGetProcAddress("glGenFencesNV");
    s_gl.glIsFenceNV = (glIsFenceNV_t) s_egl.eglGetProcAddress("glIsFenceNV");
    s_gl.glTestFenceNV = (glTestFenceNV_t) s_egl.eglGetProcAddress("glTestFenceNV");
    s_gl.glGetFenceivNV = (glGetFenceivNV_t) s_egl.eglGetProcAddress("glGetFenceivNV");
    s_gl.glFinishFenceNV = (glFinishFenceNV_t) s_egl.eglGetProcAddress("glFinishFenceNV");
    s_gl.glSetFenceNV = (glSetFenceNV_t) s_egl.eglGetProcAddress("glSetFenceNV");
    s_gl.glGetDriverControlsQCOM = (glGetDriverControlsQCOM_t) s_egl.eglGetProcAddress("glGetDriverControlsQCOM");
    s_gl.glGetDriverControlStringQCOM = (glGetDriverControlStringQCOM_t) s_egl.eglGetProcAddress("glGetDriverControlStringQCOM");
    s_gl.glEnableDriverControlQCOM = (glEnableDriverControlQCOM_t) s_egl.eglGetProcAddress("glEnableDriverControlQCOM");
    s_gl.glDisableDriverControlQCOM = (glDisableDriverControlQCOM_t) s_egl.eglGetProcAddress("glDisableDriverControlQCOM");
    s_gl.glExtGetTexturesQCOM = (glExtGetTexturesQCOM_t) s_egl.eglGetProcAddress("glExtGetTexturesQCOM");
    s_gl.glExtGetBuffersQCOM = (glExtGetBuffersQCOM_t) s_egl.eglGetProcAddress("glExtGetBuffersQCOM");
    s_gl.glExtGetRenderbuffersQCOM = (glExtGetRenderbuffersQCOM_t) s_egl.eglGetProcAddress("glExtGetRenderbuffersQCOM");
    s_gl.glExtGetFramebuffersQCOM = (glExtGetFramebuffersQCOM_t) s_egl.eglGetProcAddress("glExtGetFramebuffersQCOM");
    s_gl.glExtGetTexLevelParameterivQCOM = (glExtGetTexLevelParameterivQCOM_t) s_egl.eglGetProcAddress("glExtGetTexLevelParameterivQCOM");
    s_gl.glExtTexObjectStateOverrideiQCOM = (glExtTexObjectStateOverrideiQCOM_t) s_egl.eglGetProcAddress("glExtTexObjectStateOverrideiQCOM");
    s_gl.glExtGetTexSubImageQCOM = (glExtGetTexSubImageQCOM_t) s_egl.eglGetProcAddress("glExtGetTexSubImageQCOM");
    s_gl.glExtGetBufferPointervQCOM = (glExtGetBufferPointervQCOM_t) s_egl.eglGetProcAddress("glExtGetBufferPointervQCOM");
    s_gl.glExtGetShadersQCOM = (glExtGetShadersQCOM_t) s_egl.eglGetProcAddress("glExtGetShadersQCOM");
    s_gl.glExtGetProgramsQCOM = (glExtGetProgramsQCOM_t) s_egl.eglGetProcAddress("glExtGetProgramsQCOM");
    s_gl.glExtIsProgramBinaryQCOM = (glExtIsProgramBinaryQCOM_t) s_egl.eglGetProcAddress("glExtIsProgramBinaryQCOM");
    s_gl.glExtGetProgramBinarySourceQCOM = (glExtGetProgramBinarySourceQCOM_t) s_egl.eglGetProcAddress("glExtGetProgramBinarySourceQCOM");
    s_gl.glStartTilingQCOM = (glStartTilingQCOM_t) s_egl.eglGetProcAddress("glStartTilingQCOM");
    s_gl.glEndTilingQCOM = (glEndTilingQCOM_t) s_egl.eglGetProcAddress("glEndTilingQCOM");
...
void *gl_dispatch_get_proc_func(const char *name, void *userData)
{
    ...
    void *ret = (void*)s_gles_lib->findSymbol(name);
    if(ret) return ret;
